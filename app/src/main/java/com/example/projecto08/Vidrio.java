        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (price.getText().toString().isEmpty() ||
                    ...
                    int totalVidrio = Integer.parseInt(total.getText().toString());
                    String monthVidrio = months.getSelectedItem().toString();
                    String serial = idUser + monthVidrio;
                    int total = priceVidrio + quantityVidrio;
                    glass materialVidrio = new glass(serial, priceVidrio, quantityVidrio, total, monthVidrio, idUser);
